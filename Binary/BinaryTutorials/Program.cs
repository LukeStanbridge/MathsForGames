...
namespace BinaryTutorials
{
    internal class Program
    {
        // creating bitmasks for each weapon
        ...
        public static readonly string[] weapons = {"Fists", "Chainsaw", "Pistol", "Shotgun", "Super Shotgun", "Chaingun",
        ...
        static void Main(string[] args)
        {
            ...
            // Set indivdual bits in bitfield using OR operator
            inventory |= PLASMA_GUN;
            inventory |= PISTOL;
            inventory |= CHAINSAW;

            // to toggle a bit in the bitfield -- e.g inventory ^= ROCKET_LAUNCHER;
